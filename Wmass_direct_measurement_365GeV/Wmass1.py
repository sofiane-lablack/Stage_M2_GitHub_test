...
#		partchargees=['11','13','211']
	...
	if energypartchargeesjet1 > 0.992 * energyjet1 or energypartchargeesjet2 > 0.992 * energyjet2 or energypartchargeesjet3 > 0.992 * energyjet3 or energypartchargeesjet4 > 0.992 * energyjet4:
		continue
	...
	#cut energie dijets similaires
        ...
        if openingangledj1 <= 25 or openingangledj2 <= 25 or openingangledj1 >= 130 or openingangledj2 >= 130:
            continue

        m_small, m_large = return_mass(dijet)

        #cut sur la masse de mW1 small mW2 large
        if m_large<=70 or m_small>=90:               
            continue
